...
<body class="blue-style">
	<form action="/sell/create" class="form-horizontal" method = "post">
	  <div class="control-group">
	    ...
	    <div class="controls">
		    <input type="text" placeholder="单价" name = "price" required>
	    </div>
	    <label class="control-label" >时间</label>
	    <div class="controls">
		    <input type="text" placeholder="时间" name = "date" required>
	    </div>
